...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", default="/home/gph/disks/FILE/Data/event_cnn_min/bad_h5", help="ROS bag file to extract or directory containing bags")
    parser.add_argument("--output_dir", default="/home/gph/disks/FILE/Data/event_cnn_min/bad_h5", help="Folder where to extract the data")
