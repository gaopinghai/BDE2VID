...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", default="/media/gph/DATA/DATA/E2VID Dataset/calibration.zip", help="txt file to extract or directory containing txt files")
    parser.add_argument("--output_dir", default="/media/gph/DATA/DATA/E2VID Dataset/", help="Folder where to extract the data")
