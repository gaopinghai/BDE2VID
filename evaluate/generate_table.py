...
if __name__ == '__main__':
    ...
    args.res_dir = "result/txtfiles"
    args.out_file = 'rec_org_vs_epoch269.txt'
    # args.loss = ['mse']
    args.loss = None

    res_files = glob.glob(os.path.join(args.res_dir, "*.txt"))
    generate_table(res_files, args.out_file, args.loss)
